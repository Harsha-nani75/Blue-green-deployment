...
It builds on top of the [Multi-Service Docker project](https://roadmap.sh/projects/multiservice-docker) and shows how to deploy applications **with zero downtime and zero data loss**.
